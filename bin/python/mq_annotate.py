...
id2ipr = pickle.load( open( outpath +'/gsea/id2ipr.p', 'rb' ) )
...
data['_ipr.term.union'] = data['ORF ids - all strains'].apply(iprintersect)
...
ipr_df.to_csv(outpath +'/gsea/ipr2proteingroups.csv')
